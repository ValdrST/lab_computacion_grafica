/*
Semestre 2020-2
Proyecto animacion Computacion grafica 
*/
//para cargar imagen
...
int main() 
{
	...
	skyboxFacesDia.push_back("Textures/Skybox/hillsDay/left.tga");
	skyboxFacesDia.push_back("Textures/Skybox/hillsDay/right.tga");
	skyboxFacesDia.push_back("Textures/Skybox/hillsDay/bottom.tga");
	skyboxFacesDia.push_back("Textures/Skybox/hillsDay/up.tga");
	skyboxFacesDia.push_back("Textures/Skybox/hillsDay/front.tga");
	skyboxFacesDia.push_back("Textures/Skybox/hillsDay/back.tga");

	std::vector<std::string> skyboxFacesNoche;
	
	skyboxFacesNoche.push_back("Textures/Skybox/hillNoche/left.tga");
	skyboxFacesNoche.push_back("Textures/Skybox/hillNoche/right.tga");
	skyboxFacesNoche.push_back("Textures/Skybox/hillNoche/bottom.tga");
	skyboxFacesNoche.push_back("Textures/Skybox/hillNoche/up.tga");
	skyboxFacesNoche.push_back("Textures/Skybox/hillNoche/front.tga");
	skyboxFacesNoche.push_back("Textures/Skybox/hillNoche/back.tga");

		std::vector<std::string> skyboxFacesNight;
	
	skyboxFacesNight.push_back("Textures/Skybox/hillNight/left.tga");
	skyboxFacesNight.push_back("Textures/Skybox/hillNight/right.tga");
	skyboxFacesNight.push_back("Textures/Skybox/hillNight/bottom.tga");
	skyboxFacesNight.push_back("Textures/Skybox/hillNight/up.tga");
	skyboxFacesNight.push_back("Textures/Skybox/hillNight/front.tga");
	skyboxFacesNight.push_back("Textures/Skybox/hillNight/back.tga");

	std::vector<std::string> skyboxFacesStar;
	
	skyboxFacesStar.push_back("Textures/Skybox/Stars/left.tga");
	skyboxFacesStar.push_back("Textures/Skybox/Stars/right.tga");
	skyboxFacesStar.push_back("Textures/Skybox/Stars/bottom.tga");
	skyboxFacesStar.push_back("Textures/Skybox/Stars/up.tga");
	skyboxFacesStar.push_back("Textures/Skybox/Stars/front.tga");
	skyboxFacesStar.push_back("Textures/Skybox/Stars/back.tga");
	
	std::vector<std::string> skyboxMountStar;
	
	skyboxMountStar.push_back("Textures/Skybox/mountStar/left.tga");
	skyboxMountStar.push_back("Textures/Skybox/mountStar/right.tga");
	skyboxMountStar.push_back("Textures/Skybox/mountStar/bottom.tga");
	skyboxMountStar.push_back("Textures/Skybox/mountStar/up.tga");
	skyboxMountStar.push_back("Textures/Skybox/mountStar/front.tga");
	skyboxMountStar.push_back("Textures/Skybox/mountStar/back.tga");
