...
int main() 
{
	...
	Camino_M = Model();
	Camino_M.LoadModel("Models/railroad_track.obj");
...
//contador de luces puntuales
	...
	while (!mainWindow.getShouldClose())
	{
		...
		deltaTime = 5*(now - lastTime); 
		lastTime = now;
		if(movCoche < 13.0f && sentido_carro == 1)
			{
		...
		if(movCoche > -10.0f && sentido_carro == 0){
			movCoche -= movOffset * deltaTime;
			giro_rueda -= giro_offset * deltaTime;
		}else{
			sentido_carro = 1;
		...
		model = glm::mat4(1.0);
		kitt_pos = glm::vec3(movCoche, -1.4f, 0.5f);
		spotLights[2].SetPos(glm::vec3(movCoche-1.0f, -1.4f, 0.5f));
		spotLights[3].SetPos(glm::vec3(movCoche-1.0f, -1.4f, -1.5f));
		spotLights[4].SetPos(glm::vec3(movCoche-1.0f, -1.4f, 0.5f));
		spotLights[5].SetPos(glm::vec3(movCoche-1.0f, -1.4f, -1.5f));
		if(sentido_carro == 1){
			spotLights[4].SetColor(glm::vec3(0.0f,0.0f,1.0f));
			spotLights[5].SetColor(glm::vec3(0.0f,0.0f,1.0f));
