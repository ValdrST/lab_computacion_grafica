...
//luces spotlight
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//instanciar su dado
		model = glm::mat4(1.0);
		dadoPos = glm::vec3(3.0f+mainWindow.getmuevex(), 0.0f+mainWindow.getmuevey(), -1.0f-mainWindow.getmuevez());
		spotLights[2].SetPos(dadoPos);
		model = glm::translate(model, dadoPos);
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Material_brillante.UseMaterial(uniformSpecularIntensity, uniformShininess);
